...
Можливість активувати пропозицію користувачем ${username}
  ${procurementMethodType}=  Get variable value  ${USERS.users['${username}'].tender_data.data.procurementMethodType}
  ${methods}=  Create List  competitiveDialogueUA  competitiveDialogueEU  competitiveDialogueEU.stage2  belowThreshold  aboveThresholdEU  aboveThresholdUA  closeFrameworkAgreementUA  esco  simple.defense
